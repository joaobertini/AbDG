...
/*
    public FullEvolution(NetworkFull[] networksFull, AttributeHandler[] vetAtrHandler, double[][] m, int poolsize, double n){
        ...
        for(int a = 0; a < poolsize; a++){
            ...
            for(int i = 0; i < numAttr; i++) {
                vetGAvertices[a][i] = new GAvertices(vetAtrHandler[i].getVetAtr().length);
    ...
    private GAvertices[][] vetGAvertices;
